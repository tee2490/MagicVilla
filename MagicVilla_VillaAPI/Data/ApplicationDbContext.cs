        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Villa>().HasData(
               new Villa
               {
                   ...
                   Sqft = 550,
                   Amenity = "",
                   CreatedDate = new DateTime(2030, 10, 1)
               },
             new Villa
             {
                 Id = 2,
                 ...
                 Sqft = 550,
                 Amenity = "",
                 CreatedDate = new DateTime(2030, 10, 2)
             },
             new Villa
             {
                 Id = 3,
                 ...
                 Sqft = 750,
                 Amenity = "",
                 CreatedDate = new DateTime(2030, 10, 3)
             },
             new Villa
             {
                 Id = 4,
                 ...
                 Sqft = 900,
                 Amenity = "",
                 CreatedDate = new DateTime(2030, 10, 4)
             },
             new Villa
             {
                 Id = 5,
                 ...
                 Sqft = 1100,
                 Amenity = "",
                 CreatedDate = new DateTime(2030, 10, 5)
             });
        }
